...
function NFTDropPage({ collection }: Props) {
  ...
  const mintNft = () => {
    ...
    setLoading(true)
    const notification = toast.loading('Minting ETH...', {
      style: {
        background: 'white',
        color: 'green',
        fontWeight: 'bolder',
    ...
    nftDrop
      ...
      .then(async (tx) => {
        ...
        const claimedToken = tx[0].id //the id of the NFT claimed
  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      <div className="bg-gradient-to-br from-cyan-800 to-rose-500 lg:col-span-4">
        <div
          className=" flex flex-col items-center justify-center py-2 lg:min-h-screen
        "
        >
        ...
        <header className="flex items-center justify-between">
          <Link href={'/'}>
            <h1 className="w-52 cursor-pointer text-xl font-extralight sm:w-80">
              The{' '}
              <span className="font-extrabold underline decoration-pink-700/50">
                NFT Market
              </span>{' '}
              Place
            </h1>
